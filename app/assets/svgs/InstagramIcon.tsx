...
// Official 2022 Instagram logo — four radial gradients layered
// under a camera silhouette to reproduce the brand's magenta →
// orange → yellow → purple wash. `useId()` prefixes all internal
// gradient IDs so multiple copies on the same page (About + Sidebar)
// don't collide with each other's fills.
export const InstagramIcon: React.FC<{
  ...
  return (
    ...
    >
      ...
      <g>
        <path d={bgPath} fill={`url(#${id("e")})`} transform="translate(-71.8155 -18.1429)" />
        <path d={bgPath} fill={`url(#${id("f")})`} transform="translate(-71.8155 -18.1429)" />
        <path d={bgPath} fill={`url(#${id("g")})`} transform="translate(-71.8155 -18.1429)" />
        <path d={bgPath} fill={`url(#${id("h")})`} transform="translate(-71.8155 -18.1429)" />
        <path
          fill="#fff"
